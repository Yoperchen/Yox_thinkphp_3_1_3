...
class BrandModel extends Model {
	...
	public function getBrandById($id=0){
		...
		$brand_info		 = $this->where(array('id'=>$id))->find();
		$data=array('status'=>1,'message'=>'成功','data'=>$brand_info);
		return $data;
	 ...
	 * @return array
	 */
	public function get_brand_list($condition,$page_size=20){
...
// 		$this->assign('page',$show);// 赋值分页输出
	 ...
	 * @param array $data
	 */
	public function update_brandById($id,$data){
	...
	public function del_brand($condition)
	{
