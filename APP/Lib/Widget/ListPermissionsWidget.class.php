...
class ListPermissionsWidget extends Widget{  
    public function render($data){ 
    	$data['application'] = isset($data['application'])?$data['application']:'Common';
    	$Template = '';//模版
    	$Template = isset($data['template'])?$data['template']:'ListPermissions';
    	
    	$Permissions_model  =   D('Permissions');
...
//     	$condition['author']=$data['condition']['author']?array('like','%'.$data['condition']['author'].'%'):'';//作者
    	...
    	$list_article_result = $Permissions_model-> get_permission_list($condition,$data['page']['page_size']);
