...
class ApibaseAction extends Action{
	...
	public $api_array = array(
	    ...
	    'address'=>array(
	        ...
	        4006=>array(
	            'api'=>'Api/address/add_community','title'=>'add_community添加社区','description'=>'add_community(添加社区)',
	            'parameters'=>array(
	                array('name'=>'name','required'=>1,'description'=>'社区名称'),
	                array('name'=>'desc','required'=>1,'description'=>'社区描述'),
	        ...
	        4007=>array(
	            'api'=>'Api/address/get_community_list','title'=>'get_community_list添加社区','description'=>'get_community_list(社区列表)',
	            'parameters'=>array(
	                array('name'=>'name','required'=>0,'description'=>'社区名称'),
	                array('name'=>'is_school','options'=>array('0'=>'非学校','1'=>'学校',),'required'=>0,'description'=>'是否只要学校'),
                    array('name'=>'city_id','required'=>0,'description'=>'城市id'),
	        ...
	        4008=>array(
	            'api'=>'Api/address/get_community_info','title'=>'get_community_info添加社区','description'=>'get_community_info(获取社区信息)',
	            'parameters'=>array(
	                array('name'=>'community_id','required'=>1,'default_value'=>'1','description'=>'社区ID'),
	            ),
	        ),				//获取社区信息
	        4009=>array(
	 ...
	 */
	protected function check_parameters_legality()
	{
	    ...
	    $get_result = $Partner_api_model->getPartnerByUserName($api_partner);
	    if(empty($get_result['data'])){
	        $result['message']='api_partner错误';
	        return $result;
	    }
	    $check_result = $Partner_api_model->check_sign($_REQUEST,$api_sign);
