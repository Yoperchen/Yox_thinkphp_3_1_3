...
<title>视频首页_零零糖购物网站_我和僵尸有个约会</title>
...
require(['jquery'], function($){
	$(function($) {
        ...
        <div id="bd">
            <div id="crumble">
               <a href="<?php echo U('Yo81008/Index/index');?>" title="零零糖网购首页" onclick="">零零糖网购首页</a>
               <span>&gt;</span>视频
            </div>
                    ...
                    <div class="hd">
                        ...
                        <i class="dotline"></i>
                                        ...
                                        <div class="bd clearfix">
                                            ...
                                            <span><a href="http://www.qiyi.com/" target="_blank" class="yd-black">奇艺高清</a></span>
