...
<div class="block clearfix">
    	<a href="<?php echo (($site_info['url'])?($site_info['url']):'/'); ?>" class="fleft"><img title="<?php echo (($site_info['site_name'])?($site_info['site_name']):'没有名称'); ?>" src="<?php echo (($site_info['logo'])?($site_info['logo']):'__PUBLIC__/Widget/Header/Yocms_header_1/linglingtang_short_coffee_logo.png'); ?>"></a>
        <div class="fright">
