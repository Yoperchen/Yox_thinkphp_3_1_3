...
<head>
    ...
    <style type="text/css">
        ...
        .login_bg
        {
			...
			bottom: 0;
			left: 0;
			background-image:url(../Public/admin_image/bg_1.jpg);
...
<body>
    <div id="login_bg" class ="login_bg" style="background-image:url(../Public/admin_image/u3.jpg);"></div>
    ...
    <div class="container">
        ...
        <div class="signup_forms" class="signup_forms">
            	<div id="signup_forms_container" class="signup_forms_container">
                    	<form class="signup_form_form" id="sign_form" method="post" action="<?php echo U('Yo81009/Admin/site_login');?>">
    ...
    <div class="footer">
    	<div class="footer_signup_link">
        	<a class="signup_link" href="<?php echo U('Yo81009/Admin/site_register');?>">注册</a>
