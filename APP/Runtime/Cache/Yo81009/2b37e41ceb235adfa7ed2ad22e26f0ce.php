...
<head>
    ...
    <script type="text/javascript">
    	$(function(){
			...
			{
				alert('Waring!','email password and username mustn\'t be empty!');
			...
			else
			{
				...
				{
						alert('Waring','Your password is not same!');
						$("#signup_password").val("");
...
<body>
    <div id="login_bg" class ="login_bg" style="background-image:url(../Public/admin_image/blog_bg.jpg);"></div>
    ...
    <div class="footer">
    	<div class="footer_signup_link">
        	<a class="signup_link" href="<?php echo U('Yo81009/Admin/site_login');?>">登录</a>
            <a href="https://www.linglingtang.com" target="_blank" class="link unnamed_1">Contact</a>
