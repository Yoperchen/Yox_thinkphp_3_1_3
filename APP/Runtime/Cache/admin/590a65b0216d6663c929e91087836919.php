...
<ul>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Article/article_detail@'.$application,array('article_id'=>$article['id']));?>" target="_blank"><?php echo (($article['title'])?($article['title']):'木有标题'); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
</div>
